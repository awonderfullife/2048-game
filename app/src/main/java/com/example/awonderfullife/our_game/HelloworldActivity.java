...
public class HelloworldActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        my_button = (Button)findViewById(R.id.left_button);
        my_button.setText("操作说明");
        my_button.setOnClickListener(new MyButtonListener2());

        my_button = (Button)findViewById(R.id.mid_button);
        my_button.setText("关于我们");
    ...
    class MyButtonListener2 implements OnClickListener{
        public void onClick(View v) {
            // TODO Auto-generated method stub
            Intent intent = new Intent();
            intent.setClass(HelloworldActivity.this, NextActivity2.class);
            HelloworldActivity.this.startActivity(intent);
        }
    }
    ...
    class MyButtonListener3 implements OnClickListener{
        public void onClick(View v) {
            // TODO Auto-generated method stub
            Intent intent = new Intent();
            intent.setClass(HelloworldActivity.this, NextActivity3.class);
            HelloworldActivity.this.startActivity(intent);
        }
    }
